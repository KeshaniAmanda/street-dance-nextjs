...
import signImg from "../assets/Bd1.jpg";
...
const Sanu = () => {
  ...
  <span className="font-bold">BREAKDANCE</span>
</h1>
...
<h2 className="text-white text-4xl md:text-5xl mt-2">
 CLASS<span className="font-semi"></span>
      ...
      <div className="mt-24 w-[1200px] md:w-[1400px] mx-auto bg-[#e6f0ff] text-[#3883fc] text-sm px-5 md:px-12 py-3">
