...
import h6a from "../assets/h6a.jpg";
import h6b from "../assets/h6b.jpg";
import h6c from "../assets/h6c.jpg";
            ...
            <div className="mt-4">
              ...
              <div className="text-xs flex flex-wrap items-center gap-4 mb-2">
                ...
                <span
                  ...
                  className="flex items-center gap-2 text-gray-400 hover:text-yellow-500 cursor-pointer transition duration-300"
                >
                ...
                <span className="flex items-center gap-1 text-gray-400">
                  <FiUser className="text-yellow-500 text-sm" />
              ...
              <h3
                onClick={() => handleTitleClick(item.id)}
                className="text-lg font-semibold text-black hover:text-yellow-500 cursor-pointer transition duration-300 mb-2"
              >
                {item.title}
              </h3>
              ...
              <button
                onClick={() => handleTitleClick(item.id)}
                className="text-yellow-500 font-semibold text-xs tracking-widest flex items-center gap-2 hover:gap-3 transition-all mt-2"
              >
                → READ MORE
              </button>
