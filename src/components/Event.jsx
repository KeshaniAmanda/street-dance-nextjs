...
export default function Events() {
  return (
    <div className="bg-[#f3f3f3]">
      ...
      {/* NAVBAR */}
      <div className="w-full absolute top-0 left-0 z-50 text-white">
        <div className="flex justify-between items-center px-10 py-6">
          <h1 className="text-3xl font-bold">VIBEZ</h1>

          <ul className="flex gap-10 text-sm tracking-widest">
            <li className="border-b-2 border-[#1abc9c] pb-1">HOMES</li>
            <li>PAGES</li>
            <li>EVENTS</li>
            <li>PORTFOLIO</li>
            <li>BLOG</li>
