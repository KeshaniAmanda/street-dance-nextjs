...
import h6a from "../assets/september6.jpg";
import h6b from "../assets/september5.jpg";
import h6c from "../assets/september4.jpg";
  ...
  return (
    <section className="w-full bg-white py-20 md:py-48 px-4 sm:px-6 md:px-16">
      ...
      <div className="grid md:grid-cols-2 gap-6 items-center mb-12 md:-mt-16">
        ...
        <p className="text-gray-500 leading-relaxed max-w-md text-right md:text-right mx-auto md:ml-auto">
